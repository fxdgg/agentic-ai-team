...
1. **Claude Code Path**: `.claude/rules/tcb/rules/{rule-name}/rule.md`
...
- Try: `.claude/rules/tcb/rules/auth-web/rule.md` first
...
1. Try `.claude/rules/tcb/rules/{rule-name}/rule.md` first (Claude Code)
...
1. `.claude/rules/tcb/rules/auth-tool/rule.md` (Claude Code)
