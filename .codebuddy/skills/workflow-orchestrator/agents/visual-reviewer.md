...
1. 确认 playwright-cli 插件可用：
   ...
   ~/.codebuddy/plugins/marketplaces/codebuddy-plugins-official/plugins/playwright-cli/
...
3. 使用 read_file 抽样检查 2-3 张截图确认内容正常：
...
4. 执行 AI 视觉对比（六维度，满分制，总分 100）：
   ⚠️ 对比方式说明：AI 通过 read_file 先后读取设计稿图片和实际截图，
