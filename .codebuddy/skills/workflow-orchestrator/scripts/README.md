...
python path_resolver.py \
  --agent-file /path/to/.codebuddy/skills/.../agents/common-developer.md \
...
```json
{
  "../../rules/java-backend/meta-rule.md": "/path/to/project/.codebuddy/skills/.../rules/java-backend/meta-rule.md",
  "../../rules/java-backend/package-structure.md": "/path/to/project/.codebuddy/skills/.../rules/java-backend/package-structure.md"
}
```
...
- **../../rules/java-backend/meta-rule.md**
  → .../.codebuddy/skills/.../rules/java-backend/meta-rule.md

- **../../rules/java-backend/package-structure.md**
  → .../.codebuddy/skills/.../rules/java-backend/package-structure.md
...
| 错误 | 原因 | 解决方案 |
|------|------|--------|
| `文件不存在` | 规则文件被移动或删除 | 检查 `.codebuddy/skills/.../rules/` 目录 |
