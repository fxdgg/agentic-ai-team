...
| 文件 | 用途 | 阶段 | 说明 |
|-----|------|------|------|
| product-analyst.md | 产品需求分析 | ANALYSE_PRODUCT | 4 个成员的 Agent Teams |
...
3. 阅读"Agent Teams 模式协作"部分 (15 分钟)
...
→ `WORKFLOW_ORCHESTRATION_GUIDE.md` § "Agent Teams 模式协作"
...
3. 调度规则 - 优先级执行顺序、Agent Teams 创建指令
...
3. Agent Teams 模式协作 - 3 个应用场景的详细工作流
...
### Q3: 我需要理解 Agent Teams 是如何工作的

**A**: 阅读 `WORKFLOW_ORCHESTRATION_GUIDE.md` § "Agent Teams 模式协作"，包括 3 个具体场景示例
