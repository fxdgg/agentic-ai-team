# ANALYSE_TECH 阶段 Agent Teams 输出格式
...
## 13. ANALYSE_TECH 阶段 Agent Teams 预览格式

```
** 📋 阶段预览: ANALYSE_TECH（Agent Teams 模式） **

📌 需求: [需求名称]
🔄 当前阶段: ANALYSE_TECH (3/13)
🚀 调度模式: Agent Teams 三成员串行协作
...
## 14. ANALYSE_TECH 阶段 Agent Teams 进度监控格式

```
** 🔄 ANALYSE_TECH 进度: Agent Teams **
...
## 15. ANALYSE_TECH 阶段 Agent Teams 总结格式

```
** ✅ 阶段完成: ANALYSE_TECH（Agent Teams 模式） **

🏷️ 团队: analyse-tech-[需求ID]
⏱️ 总耗时: [时长]
🚀 调度模式: Agent Teams（3 个成员串行协作）
